...
export default function Upload() {
  ...
  return (
    <>
      <UploadLayout>
        <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 mg:px-10 px-4">
          <div>
          ...
          <div className="mt-8 md:flex gap-6">
            {!fileDisplay ? (
              ...
              <div className="md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative">
                {isUploading ? (
                  <div className="absolute flex items-center justify-center z-10 bg-black h-full w-full rounded-[50px] bg-opacity-50">
